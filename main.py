...
def face_reco ():
    ...
    while cap.isOpened():
                ...
                for k in range(len(faces)):
                    ...
                    if min(e_distance_list) < 0.4:
                        ...
                        for i, d in enumerate(faces):
                            ...
                            # 要存储visitor人脸图像文件的路径
                            path_visitors_save_dir = "/home/pi/Desktop/keti/face/facepath/known"  # 自己在faces路径下先建一个known文件，否则可能会报错
                            # 存储格式：20xx-xx-xx-xx-xx-xxwang.jpg
                            ...
                            for name in visitor_names:
                                # 名字切片到分钟数：20xx-xx-xx-xx-xx-00wangyu.jpg
                        ...
                        for i, d in enumerate(faces):
                            ...
                            path_visitors_save_dir = "/home/pi/Desktop/keti/face/facepath/unknown"  # 自己在faces路径下先建一个unknown文件，否则可能会报错
        ...
        cv2.putText(img_rd, "SDYZ CKS", (20, 40), font, 1, (0, 0, 255), 1, cv2.LINE_AA)
        cv2.putText(img_rd, "People: " + str(len(faces)), (20, 100), font, 1, (0, 0, 255), 1, cv2.LINE_AA)
